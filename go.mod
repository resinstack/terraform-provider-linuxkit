...
require (
	...
	github.com/docker/docker v17.12.0-ce-rc1.0.20190822180741-9552f2b2fdde+incompatible // indirect
	...
	github.com/linuxkit/linuxkit v0.0.0-20200912094351-bc7205900c9d
